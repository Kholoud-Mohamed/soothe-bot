      ...
      body: Column(
        ...
        children: [
          ...
          RadioListTile<String>(
            title:
                const Text('I am not particulry discouraged about the future'),
          ...
          RadioListTile<String>(
            title: const Text('I feel discouraged about the future'),
            groupValue: selectedOption,
            value: 'b',
            onChanged: (value) {
              setState(() {
          ...
          RadioListTile<String>(
            title: const Text('I feel i have nothing to look forward to'),
            groupValue: selectedOption,
            value: 'c',
            onChanged: (value) {
              setState(() {
