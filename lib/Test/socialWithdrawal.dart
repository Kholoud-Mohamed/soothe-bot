      ...
      body: Column(
        ...
        children: [
          ...
          RadioListTile<String>(
            title: const Text('I have not lost intrest in other people  .'),
          ...
          RadioListTile<String>(
            title:
                const Text('I have lost most of my interest in other people .'),
            groupValue: selectedOption,
            value: 'c',
            onChanged: (value) {
              setState(() {
          ...
          RadioListTile<String>(
            title: const Text('I have lost all my interest in other people .'),
            groupValue: selectedOption,
            value: 'd',
            onChanged: (value) {
              setState(() {
