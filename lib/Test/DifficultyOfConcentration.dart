      ...
      body: Column(
        ...
        children: [
          ...
          RadioListTile<String>(
            title: const Text('I can work about as well as before.'),
          ...
          RadioListTile<String>(
            title:
                const Text('I have to push myself very hard to do anything .'),
            groupValue: selectedOption,
            value: 'c',
            onChanged: (value) {
              setState(() {
          ...
          RadioListTile<String>(
            title: const Text('I can\'t do any work at all.'),
            groupValue: selectedOption,
            value: 'd',
            onChanged: (value) {
              setState(() {
