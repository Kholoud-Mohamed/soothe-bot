...
import 'package:mapfeature_project/Test/guilt.dart';
import 'package:mapfeature_project/Test/senseOf%20Failure.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          RadioListTile<String>(
            title: const Text('I don\'t  enjoy things the way I used to.'),
            groupValue: selectedOption,
            value: 'b',
            onChanged: (value) {
              setState(() {
          ...
          RadioListTile<String>(
            title: const Text('I am dissatisfied or bored with everything.'),
            groupValue: selectedOption,
            value: 'd',
            onChanged: (value) {
              setState(() {
            ...
            icon: GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => SenseOfFailure()));
              },
            ...
            icon: GestureDetector(
              onTap: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => Guilt()));
              },
