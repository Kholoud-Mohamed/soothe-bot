...
import 'package:mapfeature_project/Test/loathing.dart';
import 'package:mapfeature_project/Test/suicidalIdeas.dart';
      ...
      body: Column(
        ...
        children: [
          ...
          RadioListTile<String>(
            title: const Text(
                'I  don\'t feel  I am any worse than any body else .'),
          ...
          RadioListTile<String>(
            title: const Text('I blame myself all the time for my faults .'),
            groupValue: selectedOption,
            value: 'c',
            onChanged: (value) {
              setState(() {
          ...
          RadioListTile<String>(
            title:
                const Text('I blame myself for any thing bad that happens .'),
            groupValue: selectedOption,
            value: 'd',
            onChanged: (value) {
              setState(() {
